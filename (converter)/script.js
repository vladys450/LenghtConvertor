function lengthConverter(source, valNum) {
    ...
    let inputFeet = document.querySelector("#inputFeet");
    let inputMeters = document.querySelector("#inputMeters");
    let inputInches = document.querySelector("#inputInches");
    let inputcm = document.querySelector("#inputcm");
    let inputYards = document.querySelector("#inputYards");
    let inputKilometers = document.querySelector("#inputKilometers");
    let inputMiles = document.querySelector("#inputMiles");
